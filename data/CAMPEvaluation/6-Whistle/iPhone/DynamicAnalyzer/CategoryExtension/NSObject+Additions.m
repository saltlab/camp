...
+ (BOOL)resolveClassMethod:(SEL)aSEL {
    NSLog(@"resolveClassMethod:    [%@ %@]", NSStringFromClass([self class]), NSStringFromSelector(aSEL));
    return YES;
}
...
+ (BOOL)resolveInstanceMethod:(SEL)aSEL {
    ...
    NSLog(@"resolveInstanceMethod    [%@ %@]", NSStringFromClass([self class]), NSStringFromSelector(aSEL));
    //}
