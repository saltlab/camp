...
int main(int argc, char *argv[])
{
    ...
    for(unsigned classIdx = 0; classIdx < classNamesCount; ++classIdx){
        ...
        if (!([className isEqualToString:@"AspectInfo"] ||
              ...
              [className isEqualToString:@"BKInvocationGrabber"])) {
            ...
            for(unsigned methodIdx = 0; methodIdx < methodsCount; ++methodIdx){
                ...
                if (!([propNames containsObject:methodName] || [methodName isEqualToString:@"awakeFromNib"] || [methodName isEqualToString:@"config"] || [methodName isEqualToString:@"initWithNibName:bundle:"])) {
